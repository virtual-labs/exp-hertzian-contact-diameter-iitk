...
1. Applied load P  
2. Indenter radius R  
3. Combined elastic response of indenter and specimen (reduced modulus E*)
...
Hertzian contact pressure provides a direct mechanical link between localized contact stresses and the initiation of wear in materials. During sliding or abrasive contact, real surfaces touch only at small asperities, and each asperity interaction behaves like a miniature elastic contact similar to a Hertzian indentation. The applied load becomes concentrated over a very small contact area, producing high local pressures. When the maximum contact pressure exceeds the material’s yield strength or fracture strength, the surface undergoes plastic deformation, microcracking, or material removal, which are the fundamental mechanisms of wear.

In ductile materials, excessive Hertzian pressure promotes plastic flow and ploughing, leading to groove formation and adhesive wear. In brittle materials, the subsurface tensile and shear stresses predicted by Hertzian theory can initiate cracks below the surface, causing chipping and spallation during repeated loading. Therefore, estimating Hertzian pressure helps predict whether the contact will remain elastic (low wear) or transition to plastic or fracture-dominated regimes (high wear). Materials with higher hardness and modulus generally sustain lower deformation for the same load, reducing the effective contact area growth and improving wear resistance.
